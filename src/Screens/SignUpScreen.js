    ...
    <View style={styles.container}>
      <KeyboardAvoidingView behavior="position" keyboardVerticalOffset="25">
        ...
        <Input
          ...
          error={submit.value && !fullName.valid}
        />
        <Input
          label="Phone Number"
          placeholder="example"
          onChangeText={phoneNumber.set}
          error={submit.value && !phoneNumber.valid}
        />
        <Input
          label="Email"
          placeholder="email"
        ...
        />
        <Button text="SignUp" onPress={_goToLogin} />
        ...
        <Pressable onPress={_goToLogin} style={styles.registerContainer}>
          <Text style={styles.registerText}>SignUp with Google Account</Text>
        </Pressable>
      </KeyboardAvoidingView>
    </View>
  );
